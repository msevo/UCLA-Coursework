...
{
    MapLoader ml;
    ml.load("/Users/marko/Documents/School/Y1Q2/CS32/Projects/Project 4/Project 4/Project 4/mapdata.txt");
    cout << ml.getNumSegments() << endl;
    StreetSegment tempSeg;
    ml.getSegment(19, tempSeg);
    cout << tempSeg.streetName << endl;
    cout << tempSeg.segment.start.latitudeText << endl;
    cout << tempSeg.segment.start.longitudeText << endl;
    cout << tempSeg.segment.end.latitudeText << endl;
    cout << tempSeg.segment.end.longitudeText << endl;
    cout << tempSeg.attractions[0].name << endl;
    cout << tempSeg.attractions[1].name << endl;
    cout << tempSeg.attractions[2].name << endl;
    cout << tempSeg.attractions[3].name << endl;
    cout << tempSeg.attractions[4].name << endl;
    AttractionMapper am;
    am.init(ml);
    GeoCoord tempCoord;
    am.getGeoCoord("Park Pool", tempCoord);
    cout << tempCoord.latitudeText << endl;
    cout << tempCoord.longitudeText << endl;
    
    Navigator nav;
    nav.loadMapData("/Users/marko/Documents/School/Y1Q2/CS32/Projects/Project 4/Project 4/Project 4/mapdata.txt");
    vector<NavSegment> directions;
    cout << nav.navigate("1061 Broxton Avenue", "Headlines!", directions) << endl;
}
*/
